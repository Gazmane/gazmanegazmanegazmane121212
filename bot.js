...
const client = new Discord.Client();
client.on('ready', () => {
  client.user.setGame(`on 15 servers | *help | By ! HD |19|☞ĠάŹ๓Âŉę☜Ðz#4344 .`,'https://www.twitch.tv/v5bz');
  console.log('---------------');
  console.log(' Bot Is Online')
  console.log('---------------')
});
...
client.on('message', msg => {
  if (msg.content === '$suppport') {
    msg.reply('السيرفر للمساعده,https://discord.gg/2MmcnUc');
  }
});
client.on("message", message => {
...
client.login("NDYxNDUxNTE2ODIyMjkwNDMy.DiywXw.MjEsPOqv6zI2y05gpemBnxA04b0");
